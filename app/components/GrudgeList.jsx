...
export default function GrudgeList() {
    ...
    return (
        <div style={{ margin: '20px' }}>
            <h3 style={{ margin: '20px 0px' }} data-test="grudge-title">{title}</h3>
            <div>
                <TextField
                    label="Add Grudge"
                    variant="filled"
            ...
            <Button onClick={addGrudge} data-test="grudge-button">
                Add Grudge
            </Button>
                        ...
                        grudges.map((g) => {
                            return (
                                <li key={g.id}>
                                    ...
                                    <Button onClick={() => deleteGrudge(g)} data-test="delete-grudge">
                                        X
                                    </Button>
                                </li>
                            )
            ...
            {
                grudges.length > 0 && <Button onClick={clearGrudges} data-test="clear-grudges">Clear</Button>
            }
        </div>
    )
}